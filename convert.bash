...
# This script converts all media files in the current directory and its subdirectories to the .mp4 format, and gives the user an option for what to do with the original files, with a progress prompt, and allow the user to choose the desired quality of the video and audio.
